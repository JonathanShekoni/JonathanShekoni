...
- 💡 Interests: Software Engineering, Data Engineering, Sports Analytics, AI/ML
- 💬 Working On: An NBA player comparison web app with a Flask REST API backend and React frontend
